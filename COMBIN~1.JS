...
(function installMultiStreetWalker() {
  ...
  function _navGuardCheck(el) {
    ...
    try {
      ...
      // top nav region is typically <80px from viewport top
      if (rect.top < 70) return { ok: false, reason: 'rect_top_in_nav_band:' + Math.round(rect.top) };
      // also catch zero-size or offscreen elements
