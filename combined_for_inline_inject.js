 ...
 *   __msEmitSessionRecord), matching cloud_sync/ledger.py finalize-session.
 *   Cross-chat handoff still works via __msDumpResumeCapsule (in-memory
 *   capsule paste, no file emission).
 *
 ...
 *   auto-recovered (get-rid-of-suitmap protocol via reopenChipModal).
