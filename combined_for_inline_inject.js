 ...
 *
 * v9.8 (2026-05-24): monotone-board auto-alias rule. On monotone S or H
 *   flops, D and C non-board cards are recognized as aliases of their
 *   canonical (H on monotone S, S on monotone H) and excluded from
 *   workload assigned_cards at emit time. Saves ~50% of walking quota
 *   on monotone S/H boards. Recorded in card_map.auto_aliased +
 *   terminal.auto_aliased_cards for audit.
 *
 * v9.7.1 (2026-05-24): __msEmitResumeFile + per-card resume.json files
 *   removed entirely. session_record.json is the only artifact emitted at
 *   session end.
 * v9.7: introduced __msBuildSessionRecord + __msEmitSessionRecord.
 * v9.6: partialWalkOnTerminal uses pickCardCommit so suitmap aliases are
 *   auto-recovered.
